-- HỆ THỐNG FLASHMART (SỬA LỖI TỐI ƯU HÓA)
...
-- ========================================================
-- BÁO CÁO 1: Cho Marketing (Lấy tất cả khách hàng & số đơn)
-- ========================================================
SELECT 
    c.customer_id, 
    c.name, 
...
-- ========================================================
-- BÁO CÁO 2: Cho Kho vận (Lấy các sản phẩm chưa bán được - Anti-Join)
-- ========================================================
SELECT 
    p.product_id, 
    p.product_name
